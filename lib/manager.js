 ...
 *      or ManagerType.createSubClass(callPrefix, meteorCallDefinitions, meteorTopicSuffixes, primaryDbObjectType, properties, extensions)
 * Parameters in order:
...
ManagerType.createSubClass = function() {
    ...
    var subClassType, callPrefix,meteorCallDefinitions, primaryDbObjectType, properties, extensions;
    var argIndex = 0;
    if (typeof arguments[0] === 'function') {
        ...
        meteorTopicSuffixes = arguments[argIndex++];
        subClassType = function() {
