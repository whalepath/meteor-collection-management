...
_.extend(ManagerType.prototype, {
    ...
    /**
     * functions that run after all the managers are created.
    ...
    startup: function(startupFn) {
        ...
        else if ( startupFn != null && startupFn === 'object' && !_.isEmpty(startupFn) ) {
            StartupFunctions.push(startupFn);
        } else {
            throw new Error('addStartupFunction called with something other than an non-empty object');
        }
    },
