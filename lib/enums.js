...
(function (exports) {
    ...
    var Enum = function (enumDefinition) {
        ...
        var typeName = enumDefinition.typeName;
        if ( typeName != null && !_.isString(typeName)) {
            throw new Error('typeName must be a string.');
        }
        var enumDefinitions;
        if ( typeName == null && enumDefinition.defs == null ) {
        ...
        function __createSymbol(name, enumDefinition) {
            ...
            if ( typeName != null ) {
                standardDbInstance = {};
                standardDbInstance[typeName] =symbol.dbCode;
    ...
    Enum.prototype.arrayify = function(objectWithSymbolKeys) {
        var result = [];
        var index = 0;
