...
DbObjectType.createSubClass = function(subClassTypeParam, typeNameParam, propertyNamesParam, databaseTableNameParam, extensionsParam) {
    ...
    // Put this elsewhere?
    subClassType.upsertFromUntrusted = function(clientObj, lookup, forcedValues) {
        return upsertFromUntrusted(subClassType, clientObj, lookup, forcedValues);
    };
 ...
 *
 * The method below is curried in createSubClass, and called like
 *
 * subClassType.upsertFromUntrusted(clientObj, lookup, forcedValues)
 *
 ...
 */
var upsertFromUntrusted = function(ctor, clientObj, lookup, forcedValues) {
    ...
    if ( lookup != null) {
        ...
        target = ctor.databaseTable.findOne(lookup);
    }
