...
DbObjectType.prototype = {
     ...
     *
     * @param options
     *     ignoredValues values which we ignore from the client
     *     forcedValues UNIMPLEMEMENTED values which must be present in the client.
     *     updateOnly UNIMPLEMEMENTED if we would insert, throw an error instead
     */
