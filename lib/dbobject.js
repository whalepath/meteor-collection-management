...
DbObjectType.CreateKnownOptionKeys = Object.freeze([
...
DbObjectType.create = function(fullOptions) {
    ...
    if (!_.isEmpty(_.omit(fullOptions, DbObjectType.CreateKnownOptionKeys))) {
        throw new Meteor.Error(500,
            "invalid option(s) to DbObjectType.create:",
            _.omit(fullOptions, DbObjectType.CreateKnownOptionKeys)
        );
    }
