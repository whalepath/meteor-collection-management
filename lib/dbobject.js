...
DbObjectType.prototype = {
                    ...
                    if (!jsonFn) {
                        ...
                        if (jsonHelper != null) {
                            if (typeof jsonHelper === 'string') {
                                function __fromGlobal(jsonHelper) {
                                    return this[jsonHelper];
                                }
                                jsonHelper = __fromGlobal(jsonHelper);
                            }
    ...
    extendClient: function(clientObject) {
        // 9 Sept 2014:  TO_DMR : PAT : I believe that this should be this.fromJSONValue(clientObject)
