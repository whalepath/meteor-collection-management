...
if ( typeof EJSON === 'undefined') {
    // needed for the tests to property function
...
DbObjectType.prototype = {
                ...
                if ( ! jsonFn ) {
                    ...
                    if (jsonHelper != null) {
                        if (typeof jsonHelper === 'string') {
                            if ( Meteor.isServer) {
                                jsonHelper = GLOBAL[jsonHelper];
                            } else {
                                jsonHelper = window[jsonHelper];
                            }
                        }
     ...
     * @param lookup (optional) either mongodb query to find existing or
