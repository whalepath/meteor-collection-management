...
DbObjectType.createSubClass = function(subClassTypeParam, typeNameParam, propertyNamesParam, databaseTableNameParam, extensionsParam) {
    ...
    Object.defineProperties(subClassType.prototype, {
        ...
        toJSONValue: {
            value: function (selectedPropertyNames) {
                var result = DbObjectType.prototype.toJSONValue.call(this, subClassType.prototype.specialHandling, selectedPropertyNames);
                return result;
            },
            enumerable: false
        }
    ...
    subClassType.fromJSONValue = subClassType.prototype.fromJSONValue;
