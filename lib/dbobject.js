...
OR
<SubClass> = DbObjectType.createSubClass(SubClass_function, 'typename', [ propertyNames ... ], 'collectionName');
 ...
 *
 * @param subClassType optional constructor function / don't supplied parameter 
 ...
 * @returns {*}
 */
DbObjectType.createSubClass = function(subClassType, typeName, propertyNames, databaseTableName, extensions) {
    // if the first argument is not the constructor function then shift arguments
    if ( typeof subClassType != "function" ) {
        if ( subClassType != null) {
            // only shift arguments if there was no placeholder null
            typeName = arguments[0];
            propertyNames = arguments[1];
            databaseTableName = arguments[2];
