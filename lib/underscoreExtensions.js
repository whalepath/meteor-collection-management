...
// _.pluckDeep(arr, 'deeply.nested'); // ['foo', 'bar']
    ...
    getGlobal: function() {
        ...
        try {
            ...
            // TO_PAT: This is really, really annoying.
            // debugger;
            // didn't work?
        }
        if ( global == null) {
        ...
        if ( global == null ) {
            console.warn('>>hack to get global has stopped working, global is still null. Returning empty object to avoid worse breaks.');
            debugger;
            return {};
        } else {
            return global;
